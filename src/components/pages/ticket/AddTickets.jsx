...
// Components
import InputForm from "../../common/Inputes/InputForm";
    ...
    <div className="w-full px-40 mt-[100px]">
      ...
      <main className="mt-11">
        <div className="w-full flex flex-col">
          <p className="text-h4 font-medium gradient-text capitalize">
            add ticket
          </p>
          <p className="max-w-screen-md text-text-20 text-h7 font-normal lowercase mt-[10px]">
        ...
        <div className="mt-[50px]">
          ...
          <div className="mt-8">
            <div
              className="bg-white rounded-10 flex items-center justify-between py-4 px-3"
              style={{
            ...
            >
              <div className="flex items-center gap-x-2">
                ...
                <div className="flex flex-col">
                  <p className="text-text-30 text-h8 font-medium">
                    allowed formats
                  </p>
                  <p className="text-text-40 text-bae font-normal">
                    allowed formats: .jpg, .gif, .jpeg, .png{" "}
                  </p>
                </div>
              </div>
              <div className="">
          ...
          <div className="flex items-center gap-x-5">
            <button className="max-w-[230px] w-full mt-[20px] flex justify-center items-center text-white bg-primary-5 rounded-10 h-10 text-base font-normal gap-x-2">
              <TickIcon className="text-white" />
              add ticket
            </button>
            <button className="max-w-[170px] mt-[20px] flex justify-center items-center text-white bg-text-20 rounded-10 w-full h-10 text-base font-normal">
              cancel
            </button>
          </div>
        </div>
