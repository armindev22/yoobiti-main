...
const BestSellingTable = ({ setStage }) => {
  const data = [
    {
      name: "product test 1",
  ...
  return (
    <div className=" bg-white rounded-[20px] py-3 px-6   h-96 overflow-auto">
      <div className="grid grid-cols-4 gap-2 px-2 py-3 border-y-[1px] border-[#EFEFEF]">
        {/* Header */}
      ...
      {data.map((item, index) => (
        <div
          className="bg-white rounded-10 grid grid-cols-4  gap-2 items-center mb-2 px-2 py-3 mt-3"
          style={{
        ...
        >
          ...
          <div className="flex items-center justify-between ">
            <p className="text-sm  capitalize text-error-10">
              {item.remaining}
            </p>
